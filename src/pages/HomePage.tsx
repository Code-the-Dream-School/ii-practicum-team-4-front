...
const HomePage = () => {
  return (
    <div className="bg-light font-subtext text-primary">
      <section className="my-0 flex items-center justify-between px-0 py-2 text-center md:py-2">
        <div className="block-inline w-2/3 overflow-hidden md:w-1/3">
          <img
            src={freshProduce1}
            alt="Fresh produce"
      ...
      <section className="font-heading px-4 py-4 md:px-4">
        <div className="mx-10 p-10 md:grid md:grid-cols-2">
          <h2 className="text-error mb-4 text-center text-6xl font-bold md:max-w-xl md:text-8xl">
            Box Sizes Preview
          </h2>
          <img
            src={benefitsMob}
